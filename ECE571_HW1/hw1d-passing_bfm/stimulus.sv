...
//if ( q != 4'b0011 ) begin // or the appropriate value
//$display("ERROR at: ", $time, " count is %b ", q, "should be 4'b0011" );
...
endmodule : stimulus// Stimulus module to test the ripple carry counter
// Toggle reset and watch it count
// NOTE: There are no external ports - typical for test benches
module stimulus;
logic clk;
